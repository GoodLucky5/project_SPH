  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        ...
        />
        <button style="weight: 100px; height: 38px" @click="getPassport">
          点击获取验证码
        </button>
...
export default {
  ...
  methods: {
    ...
    async getPassport() {
      try {
        const { phone } = this;
        phone && (await this.$store.dispatch("getUsersPassport", phone));
        //即当phone真正存在的时候，才会执行第二条语句
